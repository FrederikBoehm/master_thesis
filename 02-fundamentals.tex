...
\begin{figure}[ht]
    ...
    \caption{Projected area $\sigma(\omega_o)$ \cite{sggx}.}
...
This equation cannot be solved analytically and therefore requires gradient descent based optimization of $\rho$ \cite{hybrid_mesh_volume_lods}.
